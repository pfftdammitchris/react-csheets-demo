...
const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    case 'init':
      return { ...state, theme: action.theme, columns: action.columns }
    case 'set-columns':
...
const useCheatsheet = ({
  ...
  // Initiates the previous cached state if any or set a default.
  //    + initiates column width
  React.useEffect(() => {
    ...
    // Initiate the state. The UI will display a loading spinner until this completes
